...
-------------------------------------------------------------------------------------------------------
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_m24")

SWEP.Category = "ARC9 - SCP: 5K"
SWEP.SubCategory = "Sniper Rifles"

SWEP.AdminOnly = false
SWEP.PrintName = "M24A3"
...
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9/scp5K/m24/v_m24.mdl"
SWEP.UseHands = true
...
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     Pos = Vector(-3, 4.5, -4), -- non tpik (while on ground, on npc etc)
     Ang = Angle(-5, 0, 180),
     TPIKPos = Vector(-6, 8, -4), -- arc9_tpik 1, you can make cool poses with it
...
-- Recoil ---------------------------------------------------------------------------------------------
SWEP.Recoil 					= 0.3 * (GetConVar("arc9_scp5k_mult_recoil"):GetFloat())
...
SWEP.SubtleVisualRecoilSpeed 				= 1.4 -- speed of it, be careful with this, 0.3 - 1.75

SWEP.RecoilKick 							= 10 * (GetConVar("arc9_scp5k_mult_recoilkick"):GetFloat())
...
SWEP.CustomizePos = Vector(15, 31, 4.5)
SWEP.CustomizeRotateAnchor = Vector(15, -4, -2)
...
SWEP.DropMagazineModel 			= "models/weapons/arc9/scp5K/m24/w_m24_mag.mdl" -- Set to a string or table to drop this magazine when reloading.
...
-- Sounds ---------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ShootSound               	= { "5K_M24.Fire" }
SWEP.ShootSoundSilenced       	= { "5K_M24.FireSil" } 
...
SWEP.AttachmentElements = {
	["5K_m24_rail"] = { Bodygroups = { {4, 1} } },
	["5K_m24_rear_down"] = { Bodygroups = { {2, 1} } },
	["5K_m24_front_down"] = { Bodygroups = { {3, 1} } },
}
...
SWEP.Attachments = {
    ...
    -- },
    {
		...
		InstalledElements = {"5K_m24_rear_down", "5K_m24_front_down"},
		CorrectiveAng = Angle(0.12, -0.15, 0),
		Pos = Vector(-0, -0.2, 1.75),
        Ang = Angle(0, 90, -0),
    },
	-- {
        -- PrintName = "Magazine",
	...
	{
		PrintName = "Sticker 1",
        StickerModel = "models/weapons/arc9/scp5K/m24/sticker_1.mdl",
        Category = "stickers",
    },
	{
		PrintName = "Sticker 2",
        StickerModel = "models/weapons/arc9/scp5K/m24/sticker_2.mdl",
        Category = "stickers",
    },
	{
		PrintName = "Sticker 3",
        StickerModel = "models/weapons/arc9/scp5K/m24/sticker_3.mdl",
        Category = "stickers",
    },
	{
		PrintName = "Sticker 4",
        StickerModel = "models/weapons/arc9/scp5K/m24/sticker_4.mdl",
        Category = "stickers",
    },
}
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		EventTable = {
			{s = "5K_m24.MagOut", t = 0 / 30},
			{s = "5K_m24.MagPouch", t = 18 / 30},
			{s = "5K_m24.MagIn", t = 42 / 30},
        },
    },
	["reload_empty"] = {
        Source = {"reload_empty"},
		...
		EventTable = {
			{s = "5K_m24.MagOutEmpty", t = 0 / 30},
			{s = "5K_m24.MagPouchEmpty", t = 18 / 30},
			{s = "5K_m24.MagInEmpty", t = 60 / 30},
			{s = "5K_m24.Bolt", t = 85 / 30},
        },
    },
    --------------------------------------------------- Tacticool
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "5K_m24.InspectRotate", t = 0 / 30},
			{s = "5K_m24.InspectBoltBack", t = 45 / 30},
			{s = "5K_m24.InspectBoltForward", t = 68 / 30},
        },
    },
	["magcheck"] = {
        Source = {"magcheck"},
		...
		EventTable = {
            {s = "5K_m24.MagCheckOut", t = 10 / 30},
			{s = "5K_m24.MagCheckIn", t = 32 / 30},
        },
    },
	--------------------------------------------------- Movement
	["idle_sprint"] = {
