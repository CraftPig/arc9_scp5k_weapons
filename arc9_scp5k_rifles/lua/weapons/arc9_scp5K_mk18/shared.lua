...
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9/scp5K/mk18/v_mk18.mdl"
SWEP.UseHands = true
...
SWEP.Recoil 					= 0.55 * (GetConVar("arc9_scp5k_mult_recoil"):GetFloat())
...
-- vm:SetPoseParameter("blend_idle_1", (inSights and ParamIdleADS) or ParamIdle)
	...
	-- if clipEmpty and not self.EmptyTime then
		-- self.EmptyTime = CurTime() + 1
	-- end
