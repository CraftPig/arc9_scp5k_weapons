...
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9/scp5K/sg556/v_sg_556.mdl"
SWEP.UseHands = true
...
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     Pos = Vector(-4, 3, -4), -- non tpik (while on ground, on npc etc)
     Ang = Angle(-5, 0, 180),
...
SWEP.DropMagazineTime 			= 2.45

SWEP.DropMagazinePos 			= Vector(-0, 0, -0) -- offsets
SWEP.DropMagazineAng 			= Angle(0, 0, 0)
SWEP.DropMagazineVelocity 		= Vector(0, -0, 0) -- Put something here if your anim throws the mag with force

SWEP.DropMagazineModel 			= "models/weapons/arc9/scp5K/mk17/w_mk17_mag.mdl" -- Set to a string or table to drop this magazine when reloading.
...
-- Sounds ---------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ShootSound               	= { "5K_SIG553.Fire" }
SWEP.ShootSoundSilenced       	= { "5K_SIG553.FireSil" } 
...
SWEP.Attachments = {
	...
	{
		PrintName = "Sticker 1",
        StickerModel = "models/weapons/arc9/scp5K/mk17/sticker_1.mdl",
        Category = "stickers",
    },
	{
		PrintName = "Sticker 2",
        StickerModel = "models/weapons/arc9/scp5K/mk17/sticker_2.mdl",
        Category = "stickers",
    },
	{
		PrintName = "Sticker 3",
        StickerModel = "models/weapons/arc9/scp5K/mk17/sticker_3.mdl",
        Category = "stickers",
    },
	{
		PrintName = "Sticker 4",
        StickerModel = "models/weapons/arc9/scp5K/mk17/sticker_4.mdl",
        Category = "stickers",
    },
}
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		EventTable = {
			{s = "5K_SIG553.MagStart", t = 0 / 30},
			{s = "5K_MK17.MagPouchDown", t = 5 / 30},
			{s = "5K_SIG553.MagOut", t = 20 / 30},
			{s = "5K_SIG553.MagIn", t = 38 / 30},
			{s = "5K_MK17.MagPouchUp", t = 60 / 30},
        },
    },
	["reload_empty"] = {
        Source = {"reload_empty"},
		...
		EventTable = {
			...
			{s = "5K_SIG553.MagOutEmpty", t = 15 / 30},
			{s = "5K_SIG553.MagInEmpty", t = 46 / 30},
			{s = "5K_SIG553.Bolt", t = 78 / 30},
        },
    },
    --------------------------------------------------- Tacticool
	["inspect"] = {
...
SWEP.CustomPoseParamsHandler = function (self, ent, iswm)
	...
	local speedReload = 3
	if inSights then
		self.blend_basepose_reload = math.Approach(self.blend_basepose_reload, 0.97, speedReload * FrameTime())
		self.blend_basepose_reload_empty = math.Approach(self.blend_basepose_reload_empty, 0.97, speedReload * FrameTime())
    else
