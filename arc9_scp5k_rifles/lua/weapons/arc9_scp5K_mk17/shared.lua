...
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9/scp5K/mk17/v_mk17.mdl"
SWEP.UseHands = true
...
SWEP.SubtleVisualRecoil 					= 0.2 -- multiplier, set to something to enable this thing
...
SWEP.RecoilKick 							= 2.5 * (GetConVar("arc9_scp5k_mult_recoilkick"):GetFloat())
