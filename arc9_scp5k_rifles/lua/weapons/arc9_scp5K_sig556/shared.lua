...
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9/scp5K/sig556/v_sig_556.mdl"
SWEP.UseHands = true
...
SWEP.CustomizeRotateAnchor = Vector(9.5, -3, -2)
...
SWEP.DropMagazineVelocity 		= Vector(-90, -0, 0) -- Put something here if your anim throws the mag with force

SWEP.DropMagazineModel 			= "models/weapons/arc9/scp5K/sig556/w_553_mag.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.AttachmentElements = {
	["5K_sig556_muzzle_blank"] = { Bodygroups = { {6, 1} } },
	["5K_sig556_rear_down"] = { Bodygroups = { {4, 1} } },
	["5K_sig556_front_down"] = { Bodygroups = { {5, 1} } },
	["5K_sig556_rail"] = { Bodygroups = { {7, 1} } },
	["5K_sig556_stock_blank"] = { Bodygroups = { {8, 1} } },
}
...
SWEP.Animations = {
	...
	["magcheck_empty"] = {
		...
		EventTable = {
            {s = "5K_SIG553.MagCheckOut", t = 0 / 30},
			{s = "5K_SIG553.MagCheckIn", t = 57 / 30},
        },
    },
	--------------------------------------------------- Movement
	["idle_sprint"] = {
